...
public class RegisterFrame extends JFrame {
	...
	public RegisterFrame() {
		...
		lblNewLabel.setBounds(173, 12, 81, 20);
		contentPane.add(lblNewLabel);

		textFieldUsername = new JTextField();
		textFieldUsername.setBounds(149, 64, 130, 20);
		...
		lblNewLabel_1.setBounds(26, 67, 92, 14);
		contentPane.add(lblNewLabel_1);

		JLabel lblNewLabel_2 = new JLabel("Password:");
		lblNewLabel_2.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		lblNewLabel_2.setBounds(26, 115, 81, 14);
		contentPane.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("Re enter password:");
		lblNewLabel_3.setFont(new Font("Segoe UI", Font.PLAIN, 12));
		lblNewLabel_3.setBounds(26, 155, 105, 14);
		contentPane.add(lblNewLabel_3);

		passwordField = new JPasswordField();
		passwordField.setBounds(149, 112, 130, 20);
		contentPane.add(passwordField);

		passwordFieldReEnter = new JPasswordField();
		passwordFieldReEnter.setBounds(149, 152, 130, 20);
